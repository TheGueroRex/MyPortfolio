...
if (btnLanguage.classList[0] == "english") {
  occupations = ["Web Developer", "Front-end Developer", "Web Designer"];
...
let typed = new Typed("#auto-input-occupation", {
  strings: occupations,
  typeSpeed: 50,
  backSpeed: 50,
  loop: true,
...
document.addEventListener("scroll", () => {
  ...
  let projectItemUpAnim = gsap.utils.toArray(".projects-row-up .project-item");
...
const starWorksAnim = () => {
  ...
  workItem.to(".works-avtar-user", { duration: 3, ease: "none", y: 335 }, 0);
};
